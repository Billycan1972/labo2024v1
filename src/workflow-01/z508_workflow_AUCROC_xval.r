...
HT_tuning_AUCROC_xval <- function( pmyexp, pinputexps, pserver="local")
{
  if( -1 == (param_local <- exp_init( pmyexp, pinputexps, pserver ))$resultado ) return( 0 )# linea fija
...
corrida_guantesblancos_202109_AUC_xval <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  DT_incorporar_dataset_default( "DT0903", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0903", "DT0903" )

  DR_drifting_guantesblancos( "DR0903", "CA0903" )
  FE_historia_guantesblancos( "FE0903", "DR0903" )

  TS_strategy_xval_202109( "TS0903", "FE0903" )

  HT_tuning_AUCROC_xval( "HT0903", "TS0903" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0903", c("HT0903","TS0903") )
...
# por favor notal como este script parte de FE0903

corrida_guantesblancos_202107_AUC_xval <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0903 y parto de alli
  TS_strategy_guantesblancos_202107( "TS0904", "FE0903" )

  HT_tuning_AUCROC( "HT0904", "TS0904" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0904", c("HT0904", "TS0904") )
...
corrida_guantesblancos_202109_AUC_xval( "gb03_AUCxval" )


# Luego partiendo de  FE0001
corrida_guantesblancos_202107_AUC_xval( "gb04_AUCxval" )

...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  cat( "\n","Inicia variables intrames c�tedra")
  ...
  cat( "\n","Fin variables intrames c�tedra")
  # Aqui debe usted agregar sus propias nuevas variables
  if (PARAM$variables_iter1) {
    cat( "\n","Inicio variables combinadas agregadas iteraci�n 1")
    ...
    cat( "\n","Fin variables combinadas agregadas iteraci�n 1")
    
    if (PARAM$variables_iter2) {
      cat( "\n","Inicio variables combinadas agregadas iteraci�n 2")
      ...
      cat( "\n","Fin variables combinadas agregadas iteraci�n 2")
    }
...
# por como arm� los nombres de campos,

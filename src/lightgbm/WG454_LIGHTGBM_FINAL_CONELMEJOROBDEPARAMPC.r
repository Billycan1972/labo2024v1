...
PARAM <- list()
PARAM$experimento <- "KA4543PARAMPC"
...
PARAM$finalmodel$num_iterations <- 1548
PARAM$finalmodel$learning_rate <-0.0100192240779025
PARAM$finalmodel$feature_fraction <- 0.963940334882674
PARAM$finalmodel$min_data_in_leaf <- 1740
PARAM$finalmodel$num_leaves <- 395

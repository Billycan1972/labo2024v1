...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z531_DR_corregir_drifting_final.r"

  # No me engraso las manos con Feature Engineering manual
  param_local$variables_intrames <- TRUE
  param_local$variables_catedra <- TRUE
...
corrida_baselinef_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  DT_incorporar_dataset_default( "DT0001f2", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001f2", "DT0001f2" )

  DR_drifting_guantesblancos( "DR0001f2", "CA0001f2" )
  FE_historia_guantesblancos( "FE0001f2", "DR0001f2" )

  TS_strategy_guantesblancos_202109( "TS0001f2", "FE0001f2" )

  HT_tuning_guantesblancos( "HT0001f2", "TS0001f2" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001f2", c("HT0001f2","TS0001f2") )
...
#corrida_baselinef_202107 <- function( pnombrewf, pvirgen=FALSE )
#{
#  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001 y parto de alli
#  TS_strategy_guantesblancos_202107( "TS0002f2", "FE0001f2" )

#  HT_tuning_guantesblancos( "HT0002f2", "TS0002f2" )

  # El ZZ depente de HT y TS
 # ZZ_final_guantesblancos( "ZZ0002f2", c("HT0002f2", "TS0002f2") )
...
corrida_baselinef_202109( "baselinef012" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

#corrida_baselinef_202107( "baselinef022" )

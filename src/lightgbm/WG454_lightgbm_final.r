...
PARAM <- list()
PARAM$experimento <- "KA4540TomasFernandez14Sem"
...
PARAM$finalmodel$learning_rate <- 0.036838570723779
PARAM$finalmodel$feature_fraction <- 0.201559044166511
...
tabla_semillas <- fread( "./datasets//mis_semillas14.txt" )

...
param <- list(
  "num.trees" = 196, # cantidad de arboles
  "mtry" = 25,
  "min.node.size" = 353, # tamaño minimo de las hojas
...
ksemilla_azar <- tabla_semillas[ 1, semilla ]  # 1 es mi primer semilla1
...
dir.create("./exp/KA4318/", showWarnings = FALSE)
archivo_salida <- "./exp/KA4310/KA4318_001.csv"
...
for (envios in cortes) {
  ...
  fwrite(entrega[, list(numero_de_cliente, Predicted)],
         file = paste0('exp/KA4318/KA4318', "_", envios, ".csv"),
         sep = ","
  )
}

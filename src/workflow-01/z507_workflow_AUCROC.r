...
corrida_guantesblancos_202109_AUC <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0901", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0901", "DT0901" )

  DR_drifting_guantesblancos( "DR0901", "CA0901" )
  FE_historia_guantesblancos( "FE0901", "DR0901" )

  TS_strategy_guantesblancos_202109( "TS0901", "FE0901" )

  HT_tuning_AUCROC( "HT0901", "TS0901" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0901", c("HT0901","TS0901") )
...
corrida_guantesblancos_202107_AUC <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0902", "FE0901" )

  HT_tuning_AUCROC( "HT0902", "TS0902" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0902", c("HT0902", "TS0902") )
...
corrida_guantesblancos_202109_AUC( "gb01_AUC" )


# Luego partiendo de  FE0001

corrida_guantesblancos_202107_AUC( "gb02_AUC" )
